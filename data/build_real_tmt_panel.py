...
def write_template(path: str | Path) -> None:
    ...
    template = {
        "output_panel": "alpha_gen/data/real_tmt_daily.parquet",
        "output_metadata": "alpha_gen/data/real_metadata.json",
        "output_coverage": "alpha_gen/data/real_field_coverage.csv",
        "close_time": "15:00:00",
...
def main() -> None:
    ...
    output_panel = Path(config.get("output_panel", "alpha_gen/data/real_tmt_daily.parquet"))
    output_metadata = Path(config.get("output_metadata", "alpha_gen/data/real_metadata.json"))
    output_coverage = Path(config.get("output_coverage", "alpha_gen/data/real_field_coverage.csv"))
